                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                <div class="form-group">
                                    <div class="form-floating">
                                        <input type="text" name="NPSDNumber" class="form-control" placeholder="NPS DOCKET NO" value="{{ $NPSDOCKETNO }}" readonly="readonly">
                        ...
                        <div id="complainant" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                            <div class="accordion-body">
                                ...
                                <div class="" id="dynamicComplainant">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreComplainant[0][firstname]" class="form-control" placeholder="First Name">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreComplainant[0][middlename]" class="form-control" placeholder="Middle Name">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreComplainant[0][lastname]" class="form-control" placeholder="Last Name">
                                        </div>
