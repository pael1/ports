                                ...
                                <div class="" id="dynamicComplainant">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            ...
                                            <button type="button" name="addRespondent" data-id="{{ $value->id }}" data-bs-toggle="tooltip" title="Remove complainant" class="btn btn-danger btn-sm add deleteParty">-</button>
                                        </div>
                                    </div>
                                    @endforeach
                                    @else
                            ...
                            <div class="accordion-body">
                                <div class="" id="dynamicRespondent">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            <button type="button" name="addRespondent" data-id="{{ $value->id }}" id="addRespondent1" data-bs-toggle="tooltip" title="Remove respondent" class="btn btn-danger btn-sm add deleteParty">+</button>
                                        </div>
                                    </div>
                                    @endforeach
                                    @else
                            ...
                            <div class="accordion-body">
                                <div class="" id="dynamicWitness">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            <button type="button" name="addWitness" data-id="{{ $value->id }}" id="addWitness1" data-bs-toggle="tooltip" title="Remove witness" class="btn btn-danger btn-sm add deleteParty">-</button>
                                        </div>
                                    </div>
                                    @endforeach
                                    @else
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="attachment" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                            <div class="accordion-body">
                                ...
                                {{-- @foreach ($attachments as $file)
                                <div class="row mt-3" id="attachmentsDiv">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-6 text-center">
                                ...
                                <meta name="csrf-token" content="{{ csrf_token() }}">
                                <button type="button" data-id="{{ $file->id }}" class="btn btn-danger btn-sm deleteRecord">
                                    delete
                                </button>
                            </div>
                        </div>
