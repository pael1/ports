                                    ...
                                    <div class="" id="dynamicComplainant">
                                        @if ($complainants->count())
                                            @foreach ($complainants as $value)
                                                <div class="row mt-3">
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                                        <input type="text" name="addMoreComplainant[0][complaint_id]"
                                                            value="{{ $value->complaint_id }}" hidden>
                                                        <input type="text" name="addMoreComplainant[0][belongsTo]"
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                                        ...
                                                        <button type="button" name="addRespondent" data-id="{{ $value->id }}"
                                                            data-bs-toggle="tooltip" title="Remove complainant"
                                            ...
                                            @foreach ($lawviolated as $value)
                                                <div class="row">
                                                    ...
                                                    <div class="col-1 col-sm-1 col-md-1 col-lg-1">
                                                        <button type="button" name="addLawViolated" data-bs-toggle="tooltip"
                                                            title="Add violation" id="addLawViolated"
                                                            class="btn btn-success btn-sm add">+</button>
                                                    </div>
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="" id="dynamicRespondent">
                                        @if ($respondents->count())
                                            @foreach ($respondents as $value)
                                                <div class="row mt-3">
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                                        <input type="text" name="addMoreRespondent[0][complaint_id]"
                                                            value="{{ $value->complaint_id }}" hidden>
                                                        <input type="text" name="addMoreRespondent[0][belongsTo]"
                                                            value="{{ $value->belongsTo }}" hidden>
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                                        <button type="button" name="addRespondent" data-id="{{ $value->id }}" id="addRespondent1"
                                        ...
                                        @if ($witnesses->count())
                                            @foreach ($witnesses as $value)
                                                <div class="row mt-3">
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                                        <input type="text"
                                                            name="addMoreWitness[{{ $value->complaint_id }}][complaint_id]"
                                                            value="{{ $value->complaint_id }}" hidden>
                                                        <input type="text"
                                                            name="addMoreWitness[{{ $value->complaint_id }}][belongsTo]"
                                                            value="{{ $value->belongsTo }}" hidden>
                                                        <input type="text"
                                                            name="addMoreWitness[{{ $value->complaint_id }}][firstname]"
                                                            class="form-control" placeholder="First Name"
                                                            value="{{ $value->firstName }}">
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                                        <input type="text"
                                                            name="addMoreWitness[{{ $value->complaint_id }}][lastname]"
                                                            class="form-control" placeholder="Last Name"
                                                            value="{{ $value->lastName }}">
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                                        <input type="text"
                                                            name="addMoreWitness[{{ $value->complaint_id }}][middlename]"
                                                            class="form-control" placeholder="Middle Name"
                                                            value="{{ $value->middleName }}">
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                                        <select class="form-select"
                                                            name="addMoreWitness[{{ $value->complaint_id }}][sex]"
                                                            id="floatingSelect" aria-label="Floating label select example"
                                                            style="width:101px;">
                                                            <option value="" selected hidden>Sex</option>
                                                            <option value="Male"
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1"> <input type="text"
                                                            name="addMoreWitness[{{ $value->complaint_id }}][age]"
                                                            class="form-control ml-3" placeholder="Age" style="width:72px;"
                                                            value="{{ $value->age }}">
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3"> <input type="text"
                                                            name="addMoreWitness[{{ $value->complaint_id }}][address]"
                                                            class="form-control" placeholder="Address"
                                                            value="{{ $value->address }}">
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                                        <button type="button" name="addWitness" data-id="{{ $value->id }}" id="addWitness1"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    <button type="button"
                                                                        ...
                                                                        data-toggle="modal" data-target="#filePreview"
                                                                        class="btn btn-primary showModal btn-sm">
                                                                        View
                                                                    </button>
                                                                    <meta name="csrf-token" content="{{ csrf_token() }}">
                                                                    <button type="button" data-id="{{ $file->id }}"
                                                                        class="btn btn-danger btn-sm deleteAttachment">
                                                                        delete
                                                                    </button>
                                                                </td>
                                                            </tr>
