                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                <div class="form-group">
                                    <div class="form-floating">
                                        <input type="text" name="NPSDNumber" class="form-control" placeholder="NPS DOCKET NO" value="{{ $complaint->NPSDNumber }}" readonly="readonly">
                ...
                <div class="accordion" id="accordionPanelsStayOpenExample">
                            ...
                            <div class="accordion-body">
                                <div class="" id="dynamicComplainant">
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1 d-flex justify-content-center">
                                            <button type="button" name="addRespondent" id="addComplainant" data-bs-toggle="tooltip" title="Add complainant" class="btn btn-success btn-sm add float-right">+</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-2" id="{{ $value->id }}">
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreComplainant[{{ $value->id }}][complaint_id]" value="{{ $value->complaint_id }}" hidden>
                                            <input type="text" name="addMoreComplainant[{{ $value->id }}][id]" value="{{ $value->id }}" hidden>
                                            <input type="text" name="addMoreComplainant[{{ $value->id }}][belongsTo]" value="{{ $value->belongsTo }}" hidden>
                                            <input type="text" name="addMoreComplainant[{{ $value->id }}][firstname]" class="form-control" placeholder="First Name" value="{{ $value->firstName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreComplainant[{{ $value->id }}][middlename]" class="form-control" placeholder="Middle Name" value="{{ $value->middleName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreComplainant[{{ $value->id }}][lastname]" class="form-control" placeholder="Last Name" value="{{ $value->lastName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            <select class="form-select" name="addMoreComplainant[{{ $value->id }}][sex]" id="floatingSelect" aria-label="Floating label select example" style="width:101px;">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1"> <input type="text" name="addMoreComplainant[{{ $value->id }}][age]" class="form-control ml-3" placeholder="Age" style="width:72px;" value="{{ $value->age }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3"> <input type="text" name="addMoreComplainant[{{ $value->id }}][address]" class="form-control" placeholder="Address" value="{{ $value->address }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            <button type="button" name="removeComplainant" data-id="{{ $value->id }}" data-bs-toggle="tooltip" title="Remove complainant" class="btn btn-danger btn-sm add deleteParty">-</button>
                                        </div>
                                    </div>
                                    @endforeach
                                    @else
                        ...
                        <div id="lawviolated" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                            <div class="accordion-body">
                                <div class="" id="dynamicLawViolated">
                                    <div class="row mt-1">
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-11 d-flex justify-content-center">
                                            <b>VIOLATION</b>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1 d-flex justify-content-center">
                                    ...
                                    <div class="row" id="{{ $value->id }}">
                                        <div class="col-11 col-sm-11 col-md-11 col-lg-11">
                                            <div class="form-group">
                                                <input type="text" name="addMoreLawViolated[{{ $value->id }}][complaint_id]" value="{{ $value->complaint_id }}" hidden>
                                                <input type="text" name="addMoreLawViolated[{{ $value->id }}][id]" value="{{ $value->id }}" hidden>
                                                <input type="text" name="addMoreLawViolated[{{ $value->id }}][lawviolated]" class="form-control" placeholder="Law Violated" value="{{ $value->details }}">
                                            </div>
                                        </div>
                                        <div class="col-1 col-sm-1 col-md-1 col-lg-1">
                                            <button type="button" name="removeViolation" data-id="{{ $value->id }}" data-bs-toggle="tooltip" title="Remove Violation" class="btn btn-danger btn-sm add deleteViolation">-</button>
                                        </div>
                                    </div>
                                    @endforeach
                                    @else
                                    ...
                                    @endif
                                    <select id="select2multiple" class="selectMultiple" name="states[]" multiple="multiple">
                                        <option value="AL">Alabama</option>
                                        <option value="WY">Wyoming</option>
                                        <option value="WY">Wyom1ing</option>
                                        <option value="WY">Wyomi2ng</option>
                                        <option value="WY">Wyomin3g</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="accordion-body">
                                <div class="" id="dynamicRespondent">
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1 d-flex justify-content-center">
                                            <button type="button" name="addRespondent" id="addRespondent" data-bs-toggle="tooltip" title="Add Respondent" class="btn btn-success btn-sm add float-right">+</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-2" id="{{ $value->id }}">
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreRespondent[{{ $value->id }}][complaint_id]" value="{{ $value->complaint_id }}" hidden>
                                            <input type="text" name="addMoreRespondent[{{ $value->id }}][id]" value="{{ $value->id }}" hidden>
                                            <input type="text" name="addMoreRespondent[{{ $value->id }}][belongsTo]" value="{{ $value->belongsTo }}" hidden>
                                            <input type="text" name="addMoreRespondent[{{ $value->id }}][firstname]" class="form-control" placeholder="First Name" value="{{ $value->firstName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreRespondent[{{ $value->id }}][middlename]" class="form-control" placeholder="Middle Name" value="{{ $value->middleName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreRespondent[{{ $value->id }}][lastname]" class="form-control" placeholder="Last Name" value="{{ $value->lastName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            <select class="form-select" name="addMoreRespondent[{{ $value->id }}][sex]" id="floatingSelect" aria-label="Floating label select example" style="width:101px;">
                                                <option value="" selected hidden>Sex</option>
                                                <option value="Male" {{ $value->sex == 'Male' ? 'selected' : '' }}>Male
                                                </option>
                                                <option value="Female" {{ $value->sex == 'Female' ? 'selected' : '' }}>Female
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1"> <input type="text" name="addMoreRespondent[{{ $value->id }}][age]" class="form-control ml-3" placeholder="Age" style="width:72px;" value="{{ $value->age }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3"> <input type="text" name="addMoreRespondent[{{ $value->id }}][address]" class="form-control" placeholder="Address" value="{{ $value->address }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            <button type="button" name="removeRespondent" data-id="{{ $value->id }}" id="addRespondent1" data-bs-toggle="tooltip" title="Remove respondent" class="btn btn-danger btn-sm add deleteParty">-</button>
                                        </div>
                                    </div>
                                    @endforeach
                                    @else
                            ...
                            <div class="accordion-body">
                                <div class="" id="dynamicWitness">
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1 d-flex justify-content-center">
                                            <button type="button" name="addRespondent" id="addWitness" data-bs-toggle="tooltip" title="Add Witness" class="btn btn-success btn-sm add float-right">+</button>
                                        </div>
                                    </div>
                                    @if ($witnesses->count())
                                    ...
                                    <div class="row mt-2" id="{{ $value->id }}">
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreWitness[{{ $value->id }}][id]" value="{{ $value->id }}" hidden>
                                            <input type="text" name="addMoreWitness[{{ $value->id }}][complaint_id]" value="{{ $value->complaint_id }}" hidden>
                                            <input type="text" name="addMoreWitness[{{ $value->id }}][belongsTo]" value="{{ $value->belongsTo }}" hidden>
                                            <input type="text" name="addMoreWitness[{{ $value->id }}][firstname]" class="form-control" placeholder="First Name" value="{{ $value->firstName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreWitness[{{ $value->id }}][middlename]" class="form-control" placeholder="Middle Name" value="{{ $value->middleName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                                            <input type="text" name="addMoreWitness[{{ $value->id }}][lastname]" class="form-control" placeholder="Last Name" value="{{ $value->lastName }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            <select class="form-select" name="addMoreWitness[{{ $value->id }}][sex]" id="floatingSelect" aria-label="Floating label select example" style="width:101px;">
                                                <option value="" selected hidden>Sex</option>
                                                <option value="Male" {{ $value->sex == 'Male' ? 'selected' : '' }}>Male
                                                </option>
                                                <option value="Female" {{ $value->sex == 'Female' ? 'selected' : '' }}>Female
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1"> <input type="text" name="addMoreWitness[{{ $value->id }}][age]" class="form-control ml-3" placeholder="Age" style="width:72px;" value="{{ $value->age }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3"> <input type="text" name="addMoreWitness[{{ $value->id }}][address]" class="form-control" placeholder="Address" value="{{ $value->address }}">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-1">
                                            <button type="button" name="removeWitness" data-id="{{ $value->id }}" id="addWitness1" data-bs-toggle="tooltip" title="Remove witness" class="btn btn-danger btn-sm add deleteParty">-</button>
                                        </div>
                                    </div>
                                    @endforeach
                                    @else
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="row mt-2" id="{{ $file->id }}">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <button type="button" data-path="{{ URL::asset($file->path) }}" data-filename="{{ $file->filename }}" data-toggle="modal" data-target="#filePreview" data-bs-toggle="tooltip" title="View" class="btn btn-primary showModal btn-sm">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <meta name="csrf-token" content="{{ csrf_token() }}">
                                <button type="button" data-id="{{ $file->id }}" data-bs-toggle="tooltip" title="Remove" class="btn btn-danger add btn-sm deleteAttachment">
                                    -
                                </button>
                            </div>
                        </div>
                        ...
                        @endif
                        <input type="file" class="form-control add" name="files[]" id="customFile" accept=".pdf" multiple />
                    </div>
                </div>
        </div>
    </div>
